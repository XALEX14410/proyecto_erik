...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2025 a las 00:44:43
...
CREATE TABLE `dbo_asistencia_personas` (
  ...
  `estatusAsistencia` enum('Presente','Ausente','Reemplazado') NOT NULL DEFAULT 'Presente',
...
(1, 2, 1, '2025-04-16 01:02:48', 'Presente', NULL),
(2, 3, 1, '2025-04-16 01:02:48', 'Presente', NULL),
(3, 4, 2, '2025-04-16 01:02:48', 'Ausente', NULL);
